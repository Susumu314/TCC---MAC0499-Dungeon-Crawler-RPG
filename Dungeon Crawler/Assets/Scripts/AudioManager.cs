...
public class AudioManager : MonoBehaviour
{
	...
	public void Play(string sound, float pitchModifier = 1f)
	{
		...
		s.source.pitch = s.pitch * (1f + UnityEngine.Random.Range(-s.pitchVariance / 2f, s.pitchVariance / 2f)) * pitchModifier;
